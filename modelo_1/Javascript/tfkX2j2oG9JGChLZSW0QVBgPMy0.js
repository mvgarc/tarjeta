...
CloudflareApps.siteId = "1ffad9c0694cf63a74a40bd850a78d6a";
...
CloudflareApps.installs["Khp4Lr6sHiXQ"] = {
    appId: "-gXRR7q4QzkP",
    scope: {}
};
;CloudflareApps.installs["Khp4Lr6sHiXQ"].options = {
    "action": {
        "color": "#7110b2",
        "label": "Más información",
        "newtab": true,
        "show": true,
        "url": "https://wa.link/1oqc26"
    },
    "delay": 1,
    "paused": false,
    "position": "left",
    "renew": "0sec",
    "text": {
        "html": "\u003cp\u003e¡HAGAMOS QUE TU BODA SEA PERFECTA!\u003c/p\u003e",
        "markdown": "¡HAGAMOS QUE TU BODA SEA PERFECTA!"
    },
    "title": "📲¡Conoce nuestra plataforma!"
};
;CloudflareApps.installs["Khp4Lr6sHiXQ"].URLPatterns = ["^miboda.love/blog/?.*$", "^miboda.love/demo4/?.*$", "^miboda.love/demo5/?.*$", "^miboda.love/demo6/?.*$", "^miboda.love/index.html/?.*$"];
;CloudflareApps.installs["S8MD7F4EI8Iz"] = {
    appId: "ZCDIXCYkgZ6P",
    scope: {}
};
;CloudflareApps.installs["S8MD7F4EI8Iz"].options = {
    "behavior": {
    ...
    "message": "Aprovecha nuestra promoción de Octubre!",
    "messagePlan": "single",
    "messages": [{
        "cta": {
            "label": "",
        ...
        "endDate": "Thu Jan 2 2020 00:30",
        "useEndDate": false
    }],
    "theme": {
        "backgroundColor": "#b55a93",
        "buttonBackgroundColor": "#ffffff",
        "buttonTextColor": "#0099ff",
        "buttonTextColorStrategy": "auto",
        "style": "prominent",
        "textColor": "#ffffff"
    }
};
;CloudflareApps.installs["S8MD7F4EI8Iz"].URLPatterns = ["^www.miboda.love/blog/?.*$", "^www.miboda.love/demo4/?.*$", "^www.miboda.love/demo5/?.*$"];
;CloudflareApps.installs["S8MD7F4EI8Iz"].product = {
    "id": "basic"
};
;(function() {
    try {
...
(function() {
    ...
    script.src = '/cdn-cgi/apps/body/geUYSBtSwTT72qKDS0upEZbw3Wk.js';
